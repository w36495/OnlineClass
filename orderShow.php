        ...
        <div class="container">
            ...
            <form action="cartRemove.php" mothod="get">
                ...
                <table class="table table-hover">
                    ...
                    <?php
                    # sql 작성
                    $sql = "select * from onlineclass.order where id = '$id'";
                    ...
                    <tr class="table_th">
                        ...
                        <td><?=$row['lectureCount']?></td>
                        <td><?=$row['price']?></td>
                        <td><button type="button" class="btn btn-danger btn-xs" onclick="location.href='orderRemove.php?no=<?=$row['no']?>'">취소</button></td>
                ...
                <?php }
                            ...
                            echo "<script>alert('주문한 상품이 없습니다.');</script>";
