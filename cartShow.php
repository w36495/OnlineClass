    ...
    <nav class="header-gnb">
        ...
        <div class="container">
            ...
            <form mothod="get">
                ...
                <button type="submit" class="btn btn-default" formaction="cartRemove.php">삭제</button>
                <button type="submit" class="btn btn-default" formaction="orderAddProc.php">주문</button>
                    </div>
            </form>
        </div>
<!-- footer -->
